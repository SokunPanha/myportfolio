...
const  projects = [
  ...
  {
    name: "POS Cashier",
    description: "A real-time point-of-sale cashier system built for food and cafe stores. Features include order management, real-time updates via WebSocket, and a modern responsive UI. Currently deployed and running in production at Song Food & Coffee, a coffee shop in Phnom Penh. (Demo: username: cashier, password: cashier123)",
    ...
    type: "Side Project",
    process: "90% Complete",
    client: "Song Food & Coffee",
    location: "https://maps.app.goo.gl/FbyBYZzjooafFokA7",
  },
  {
    name: "POS Admin",
    description: "The admin dashboard for the POS Cashier system, providing store management, product catalog, sales analytics, and real-time order monitoring via WebSocket. Built for food and cafe store operations and currently running in production at Song Food & Coffee in Phnom Penh. (Demo: username: admin, password: admin123)",
  ...
  {
    name: "Digital Menu",
    description: "A customer-facing digital menu portal for restaurants and cafes, allowing customers to browse the menu, view product details, and place orders directly from their devices. Part of the POS system and currently running in production at Song Food & Coffee in Phnom Penh.",
