...
<template>
    <nav class="w-full rounded-t-lg bg-[#ffffff]/10 backdrop-blur-[5px] sticky top-0 left-0 z-50 text-white">
        <div class="flex justify-between items-center px-4 md:px-10">
            ...
            <ul class="hidden md:flex items-center md:gap-10 flex-1 justify-center">
                <li class="p-2">
        ...
        >
            <ul class="flex flex-col items-center gap-1 py-2">
                <li class="w-full text-center">
                    <NuxtLink to="/" class="block py-2 hover:bg-white/10" @click="closeMobileMenu">{{ t('nav.home') }}</NuxtLink>
                </li>
                <li class="w-full text-center">
                    <NuxtLink to="#about" class="block py-2 hover:bg-white/10" @click="closeMobileMenu">{{ t('nav.about') }}</NuxtLink>
                </li>
                <li class="w-full text-center">
                    <NuxtLink to="#work" class="block py-2 hover:bg-white/10" @click="closeMobileMenu">{{ t('nav.work') }}</NuxtLink>
                </li>
                <li class="w-full text-center">
                    <NuxtLink to="#contact" class="block py-2 hover:bg-white/10" @click="closeMobileMenu">{{ t('nav.contact') }}</NuxtLink>
                </li>
            </ul>
        </div>
    </nav>
